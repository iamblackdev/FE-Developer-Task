...
function getSortOptions(category: SwapiCategory) {
...
interface Props {
  ...
  search: string;
  sort: string;
  recentCategory: SwapiCategory | null;
        ...
        <div className={styles.controls}>
          <div className={styles.field}>
            ...
            <select
              ...
              value={category}
              onChange={(e) => onCategoryChange(e.target.value as SwapiCategory)}
            >
              {CATEGORIES.map((cat) => (
        ...
        {recentCategory && (
          <div className={styles.badgeGroup}>
            ...
            <span className={styles.badge}>
              {recentCategory.charAt(0).toUpperCase() + recentCategory.slice(1)}
            </span>
          </div>
        )}
      </div>
